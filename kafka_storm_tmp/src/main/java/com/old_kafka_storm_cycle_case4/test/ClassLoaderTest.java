package com.old_kafka_storm_cycle_case4.test;
...
public class ClassLoaderTest {
	...
	public void classTest() throws Exception{
		...
		Class claz=urlLoader.loadClass("com.old_kafka_storm_cycle_case4.test.Vdata");
	...
	public void pathtest1() throws Exception{
		...
		Class claz=loader.loadClass("com.old_kafka_storm_cycle_case4.test.Vdata");
		Object obj=claz.newInstance();
		Method method=claz.getMethod("print");
		method.invoke(obj);
	}
	...
	public void myclassloaderTest() throws Exception{
		...
		Class claz=load.loadClass("com.old_kafka_storm_cycle_case4.test.Vdata");
		Object obj=claz.newInstance();
		Method method=claz.getMethod("print");
		method.invoke(obj);
	}
